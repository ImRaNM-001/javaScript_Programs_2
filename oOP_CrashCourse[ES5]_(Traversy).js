...
function Book(title, author, year) {
    ...
    this.getSummary = function () {                                 //ways to create a function using constructor by this (old way not recommended)
...
Book.prototype.getSummary1 = function () {                            // we must write a function outside constructor using prototype keyword
    return `${this.title} was written by ${this.author} in ${this.year}`;
}
