...
function createCircle(radius){					// this is a factory function whose job is to create some objects like circle1 & circle2
...
console.log(circle2);		//prints entire cricle2 object { radius: 22, draw: [Function: draw] }
