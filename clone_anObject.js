...
console.log(another);                           // prints { radius: 1, draw: [Function: draw] }
console.log('\n<------line gap------>\n');
...
console.log(another1);                          // prints { radius: 1, draw: [Function: draw] }
console.log('\n<-----line gap------>\n');
...
console.log(another2);                          // prints { color: 'red', size: 1, radius: 1, draw: [Function: draw] }
console.log('\n<-----line gap------>\n');

another2.draw();                                // prints Draw a Circle
console.log('\n<-----line gap------>\n');


// 3- using Spread operator (most easiest way)
const another3 = {...circle};
console.log(another3);                                      // prints { radius: 1, draw: [Function: draw] }
