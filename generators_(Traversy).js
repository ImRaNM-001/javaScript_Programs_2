// Generators are nothing but functions which can be paused and resumed as many times user wants using the "yield" keyword and must be preceded with * while writing
...
// gen();          // simple calling the function won't print anything as yield has paused it, we need to store it in a variable and then call it nicely. Also if called as *gen(), it will throw error.
